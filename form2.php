    ...
    <div class="formdiv-inner">
        <div class="formcard">
          ...
          <form class="myform" action="finalcv.php" method="post" autocomplete="off">
              ...
              <input class="nam" type="text" placeholder="Name *" name="name" required />
              <br>
              ...
              <input class="objc" type="text" placeholder="Objective *" name="obj" required/><br>
              <input class="aoi" type="text" placeholder="Area of Interest 1 *" name="aoi1" required/><br>
              <input class="aoi" type="text" placeholder="Area of Interest 2" name="aoi2" /><br>
              <input class="aoi" type="text" placeholder="Area of Interest 3" name="aoi3" /><br>
              ...
              <input class="clg" type="text" placeholder="College Name *" name="college" required />
              <br>
              <select name="branch"  >
              ...
              <input type="text" placeholder="Year (ex. 2014-2018) *" name="year" required  />
              <input type="text" placeholder="CPI" name="cpi"/><br><br>
              <hr>
              <br>
              <input class="clg" type="text" placeholder="School Name (Class 12th) *" name="school12" required  />
              <input type="text" placeholder="Year (ex. 2013) *" name="year12" required  />
              <input type="text" placeholder="Percentage (ex. 95)" name="perc12"/><br><br>
              <hr>
              <br>
              <input class="clg" type="text" placeholder="School Name (Class 10th) *" name="school10" required  />
              <input type="text" placeholder="Year (ex. 2011) *" name="year10" required  />
              <input type="text" placeholder="Percentage (ex. 90)" name="perc10"/><br><br>
              <hr>
              <br>
              <span4>Internships / Trainings</span4><br>
              <input  class="clg2" type="text" placeholder="Input 1" name="it1" /><br>
              <input  class="clg" type="text" placeholder="About/City" name="it1ab"/><br>
              <br>
              <input  class="clg2" type="text" placeholder="Input 2" name="it2" /><br>
              <input  class="clg" type="text" placeholder="About/City" name="it2ab"/><br>
              <br>
